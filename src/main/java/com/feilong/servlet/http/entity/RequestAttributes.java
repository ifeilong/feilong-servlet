...
public final class RequestAttributes{
     ...
     */
    public static String INCLUDE_REQUEST_URI     = "javax.servlet.include.request_uri";
     ...
     */
    public static String INCLUDE_CONTEXT_PATH    = "javax.servlet.include.context_path";
     ...
     */
    public static String INCLUDE_SERVLET_PATH    = "javax.servlet.include.servlet_path";
     ...
     */
    public static String INCLUDE_PATH_INFO       = "javax.servlet.include.path_info";
     ...
     */
    public static String INCLUDE_QUERY_STRING    = "javax.servlet.include.query_string";
     ...
     */
    public static String FORWARD_REQUEST_URI     = "javax.servlet.forward.request_uri";
     ...
     */
    public static String FORWARD_CONTEXT_PATH    = "javax.servlet.forward.context_path";
     ...
     */
    public static String FORWARD_SERVLET_PATH    = "javax.servlet.forward.servlet_path";
     ...
     */
    public static String FORWARD_PATH_INFO       = "javax.servlet.forward.path_info";
     ...
     */
    public static String FORWARD_QUERY_STRING    = "javax.servlet.forward.query_string";
     ...
     */
    public static String ERROR_STATUS_CODE       = "javax.servlet.error.status_code";
     ...
     */
    public static String ERROR_EXCEPTION_TYPE    = "javax.servlet.error.exception_type";
     ...
     */
    public static String ERROR_MESSAGE           = "javax.servlet.error.message";
     ...
     */
    public static String ERROR_EXCEPTION         = "javax.servlet.error.exception";
     ...
     */
    public static String ERROR_REQUEST_URI       = "javax.servlet.error.request_uri";
     ...
     */
    public static String ERROR_SERVLET_NAME      = "javax.servlet.error.servlet_name";
    ...
    public static String REQUEST_CIPHER_SUITE    = "javax.servlet.request.cipher_suite";

    /** An Integer representing the bit size of the algorithm, if any. */
    public static String REQUEST_KEY_SIZE        = "javax.servlet.request.key_size";

    // ********************************************************************************************************/
    /** ATTRIBUTE_REQUEST_X509CERTIFICATE. */
    public static String REQUEST_X509CERTIFICATE = "javax.servlet.request.X509Certificate";
     ...
     * .
     */
    public static String REQUEST_SSL_SESSION     = "javax.servlet.request.ssl_session";
